            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <div class="tag_div" style="position: relative;">  
                        ...
                        <select id="select-tag" placeholder="Search Tag..." name="blog_tag[]" multiple>
                            @if(!empty($tags))
                                @foreach($tags as $tag)
                ...
                <div class="col-md-6">
                    <x-textarea label="Short Info" name="blog_summary" /> 
                </div>  
    
                <div class="col-md-6">
                    <x-drag-drop-upload name="blog_image_id" label="Blog image :" />
                </div>
                ...
                <div class="col-md-12">
                    <x-textarea label="Details" name="blog_content" class="summernote" rows="5"  />
                </div>
